...
- `CHANGELOG.md` and `docs/releases/index.md`, the two index pages, each gaining one entry for the new version. Both are generated by `collect_changelog.sh`; a hand edit here is lost on the next release.
